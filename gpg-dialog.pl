...
sub create_detached_signature {
	$input_file = file_dialog("input", "Enter input file to sign");
	$output_file = file_dialog("output", "Enter output signature file name");
...
sub create_clear_signature{
	$input_file = file_dialog("input", "Enter input file to clearsign");
...
sub verify_clear_signature {
	$input_file = file_dialog("input", "Enter input file to verify");
	call_gpg("$input_file");
}
...
sub export_keys {
	...
	$username = accept_string("Enter optional username [none exports all users]");
...
sub revoke_keys {
	$output_file = file_dialog("input", "Enter revocation certificate file name");
...
sub menu_test {
	my @menu_opts = ("Choose only one option", "First", "Second", "Third", "Fourth", "Fifth");
